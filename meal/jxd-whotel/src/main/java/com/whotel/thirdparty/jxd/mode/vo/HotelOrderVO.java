...
public class HotelOrderVO {
	...
	private String saleName; 			// 业务员名称(salesCName)
	...
	private String couponCodes;          //优惠券代码(支付优惠券编号)
	private Float couponPaidAmount;		 //优惠券抵扣金额(支付优惠券金额)
	
	private String bookChannel;
	
	private Float scorePaidAmount;//支付积分金额
	private Float returnMoneyPaidAmount;//支付返现金额
	private Float mbrCardPaidAmount;//支付会员卡余额金额
	private String scorePaidRefId;//支付积分流水号
	private String returnMoneyPaidRefId;//支付返现流水号
	private String mbrCardPaidRefId;//支付卡余额流水号
	
	public Float getScorePaidAmount() {
		return scorePaidAmount;
	}

	public void setScorePaidAmount(Float scorePaidAmount) {
	...
	public String getScorePaidRefId() {
		return scorePaidRefId;
	}

	public void setScorePaidRefId(String scorePaidRefId) {
		this.scorePaidRefId = scorePaidRefId;
	}

	public String getReturnMoneyPaidRefId() {
		return returnMoneyPaidRefId;
	}

	public void setReturnMoneyPaidRefId(String returnMoneyPaidRefId) {
		this.returnMoneyPaidRefId = returnMoneyPaidRefId;
	}

	public String getMbrCardPaidRefId() {
		return mbrCardPaidRefId;
	}

	public void setMbrCardPaidRefId(String mbrCardPaidRefId) {
		this.mbrCardPaidRefId = mbrCardPaidRefId;
	}
	...
	public class OrderDetailVO {
		...
		private String deviceId;         //门锁锁号
		
		private String authStatus;       //订单状态
