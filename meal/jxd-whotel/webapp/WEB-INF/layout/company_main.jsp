...
<head>
<meta charset="utf-8"/>
<title><decorator:title default="捷信达微信商户平台| 商户后台" /></title>
...
<link href="/static/metronic/assets/css/weiXin.css" rel="stylesheet" type="text/css"/>
...
<div class="page-container">
	<jsp:include page="company_left.jsp" />
	<!-- BEGIN CONTENT -->
	<decorator:body />
	<!-- END CONTENT -->
</div>
...
<jsp:include page="company_footer.jsp" />
...
<script src="/static/metronic/assets/scripts/app.js?v=20151112" type="text/javascript"></script>
<script src="/static/company/js/companyMain.js" type="text/javascript"></script>
