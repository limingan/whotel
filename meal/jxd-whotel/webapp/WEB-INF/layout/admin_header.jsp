	...
	<div class="header-inner">
		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown user">
				...
				<c:choose>
					<c:when test="${ADMIN_LOGIN_AVATAR != null &&  ADMIN_LOGIN_AVATAR !=''}">
						<img alt="" src="${ADMIN_LOGIN_AVATAR}" width="29" height="29"/>
					</c:when>
					<c:otherwise>
				...
				<ul class="dropdown-menu">
					<li>
						<a href="/admin/logout.do"><i class="fa fa-key"></i> 安全退出</a>
					</li>
				</ul>
			</li>
