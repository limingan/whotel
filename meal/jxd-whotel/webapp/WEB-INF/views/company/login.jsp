...
<body class="login">
  ...
  <div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="/company/login.do" method="post">
      <h3 class="form-title">商户登录</h3>
      ...
      <div class="form-group">
        ...
        <div class="input-icon">
          <i class="fa fa-user"></i> <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" name="account"/>
        </div>
      </div>
      <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="form-actions">
        ...
        <a class="pull-right" href="/company/toPwdRetrieve.do" style="color:#fff;margin-top:15px">忘记密码？</a> 
      </div>
    </form>
    <!-- END LOGIN FORM -->
  </div>
  ...
  <script src="/static/company/js/login.js" type="text/javascript"></script>
  <!-- END PAGE LEVEL SCRIPTS -->
  <script>
