...
<body class="login">
	...
	<!-- BEGIN PWDRETRIEVE -->
	<div class="content">
		<!-- BEGIN PWDRETRIEVE FORM -->
		<form class="pwdRetrieve-form" action="/company/pwdRetrieve.do" method="post">
			<h3 class="form-title">密码找回</h3>
			<div class="form-group">
				<label class="control-label visible-ie8 visible-ie9">邮箱</label>
				<div class="input-icon">
					<i class="fa fa-lock"></i> 
					<input class="form-control placeholder-no-fix" type="email" placeholder="邮箱" name="email"/>
				</div>
			</div>
	...
	<script src="/static/company/js/pwdRetrieve.js" type="text/javascript"></script>
	<!-- END PAGE LEVEL SCRIPTS -->
	<script>
