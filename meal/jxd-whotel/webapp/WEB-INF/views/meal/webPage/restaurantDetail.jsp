...
<!-- 页面样式 -->
<link rel="stylesheet" type="text/css" href="/static/meal/css/restaurantDetail.css">
...
<div class="ddb-nav-header ng-scope">
    <a class="nav-left-item" href="javascript:void(0)" onclick="history.go(-1)">
      <i class="fa fa-angle-left"></i><span style="position:absolute;top:0px">返回</span>
    </a>
...
<div class="shopInfoList">
 ...
 <div class="shopDetail">
    <img src="http://tiantianwutuo.top/attachment/images/1/2017/04/SanMzlI2yXTxyqhYt1DtILUxnY1VU2.jpg"/>
    <span >${rest.tel}</span><a href="javascript:void(0);"><i class="fa fa-angle-right"></i></a>
 </div>
