		...
		<div class="row">
				...
				<!-- 	<h3 class="page-title">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="/admin/sys/listSysRole.do">系统角色</a>
						</li>
					</ul>
			...
			<div class="portlet-body">
			     <form action="/admin/sys/listSysRole.do" id="pageForm" method="post">
		    	<input type="hidden" name="pageNo" value="${page.pageNo}" id="pageNo">
				</form>
				<div class="table-toolbar">
					<a href="/admin/sys/toEditSysRole.do" class="btn btn-sm green"><i class="fa fa-plus"></i>新增角色</a>
				</div>
				...
				<tbody>
				   <c:forEach items="${page.result}" var="role" varStatus="vs">
						...
						<td>
							<a href="toEditSysRole.do?id=${role.id}" class="btn btn-sm purple"><i class="fa fa-edit"></i> 编辑</a>
...
function deleteRole(id) {
	var url = "/admin/sys/deleteSysRole.do?id="+id;
