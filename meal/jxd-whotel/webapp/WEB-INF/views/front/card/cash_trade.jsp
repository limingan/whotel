...
<body>
<c:set var="headerTitle" value="返现账户" scope="request"/>
<jsp:include page="card_header.jsp" />

<div class="uesrtop_box pd30">
	<div class="uesrtop_ye">
		<div class="uesrtop_ye_info">
			...
			<h1><b>￥</b><fmt:formatNumber value="${totalAmount}" type="currency" pattern="#######.##" /></h1>
		</div>
	</div>
</div>
<div class="transactionDL">
	<div>
		<ul class="am-tabs-nav am-nav am-nav-tabs transactionDL_title">
			...
			<li class="tradeType <c:if test="${tradeType == 'CHARGE'}">am-active</c:if>" value="CHARGE"><a href="#tab2">返现记录</a></li>
...
<script type="text/javascript">
	$(function() {
		$(".tradeType").click(function() {
			...
			if(tradeType==""){
				document.location = "/oauth/member/cashTrade.do";
			}else{
				document.location = "/oauth/member/cashTrade.do?tradeType="+tradeType;
			}
		});
	});
</script>
