...
<body>
<body class="bodypd">
<c:set var="backUrl" value="/oauth/hotel/listHotelOrder.do?comid=${WEIXINFAN_LOGIN_COMPANYID}" scope="request"/>
<c:set var="headerTitle" value="客房预订结果" scope="request"/>
...
<div>
  ...
  <div  class="pd20 mrgtd30">
    <input  type="button" class="butstyleB" value="查看订单信息" onclick="window.open('/hotel/showHotelOrder.do?orderSn=${order.orderSn}')"/>
    <input  type="button" class="butstyleC mrgtd20" value="继续预订" onclick="window.open('/oauth/hotel/listRooms.do?comid=${order.companyId}&hotelCode=${order.hotelCode}')"/>
  </div>
</div>
